...
diagnose_drift.py
-----------------
Diagnostic: temporal drift analysis across crash eras 2010-2023.

Purpose
-------
Investigates why iter_001 (trained 2010-2019) fails on recent holdout data.
Analyzes fatal segment persistence, crash volume shifts by road group,
feature-outcome relationship stability, and new segment emergence across eras.

Key findings
------------
- Only 9.92% of fatal segments persist from training era to recent era
- 90% of recent fatal locations were never fatal during training
- Fatal segment instability is the root cause of temporal drift
- All 8 crash-history features cannot predict fatals at new locations

Date: 2026-05-15
Status: Findings locked — see docs/technical/06_drift_diagnosis.md
"""
